...
exports.lint = function(value, nameStartsWith, type) {
    ...
    if (value.search(nameStartsWith) == -1) {
        ...
        grunt.log.writeln(type + '"' + value + '"');
        grunt.log.writeln("pattern=" + nameStartsWith);
        var temp = S(value).dasherize().s;
        //console.log(temp);
        temp = capitalize(temp);
        grunt.log.writeln("recommended: " + convertRegexToString(nameStartsWith) + temp);
        grunt.log.writeln("\n");
    }
...
exports.reportLintResult = function(searchedFor, contains, value, suggestedValue) {
    ...
    grunt.log.writeln('Warning:');
    grunt.log.writeln('Searched for=' + searchedFor);
    grunt.log.writeln('name=' + value);
    grunt.log.writeln("pattern=" + contains);
    grunt.log.writeln("recommended: " + suggestedValue);
    grunt.log.writeln("\n");
}